...
class InteractiveChatVideoGenModel(L.LightningModule):
    def __init__(
        ...
        config = OmegaConf.load('/teamspace/studios/this_studio/INFERENCE_UI/VideoCrafter/configs/inference_t2v_512_v2.0.yaml')
...
@torch.no_grad()
def run_pixelspace_inference(prompt,model_repo_id,model_file_name,num_inference_steps=50,fps=24,ddim_eta=1.0,unconditional_guidance_scale=1.0,digit=1):
    global int_chat_video_gen_model
